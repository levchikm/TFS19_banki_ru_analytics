...
### 2. Поиск тематик (<username> ответственный)
  ...
  Далее попытатся применить более продвинутую модель -> найти в кластерах самых сильне представителей тематик -> потом через Baf of Words или embedding сделать semi-supervised clustering.
